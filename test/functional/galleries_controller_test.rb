...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { description: @gallery.description, id: @gallery.id, showcase_list: @gallery.showcase_list }
    end
  ...
  test "should update gallery" do
    put :update, id: @gallery, gallery: { description: @gallery.description, id: @gallery.id, showcase_list: @gallery.showcase_list }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
